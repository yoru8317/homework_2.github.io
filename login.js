function openModal() {
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var passEqualsConfPass = (myInput == confirmMyInput ? true :false;); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
